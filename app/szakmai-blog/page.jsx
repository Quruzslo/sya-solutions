...
export default async function BlogPage(props) {
  ...
  try {
    ...
    // Kategóriák lekérése a szűrő komponenshez
    ...
    // Összes találat megszámolása
    const totalPosts = await db.collection("posts").countDocuments(matchQuery);
