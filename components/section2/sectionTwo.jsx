...
export default function SectionTwo() {
  ...
  const scaleOszlop1 = useTransform(scrollYProgress, [0.2, 0.35], [0, 1])
  const scaleOszlop2 = useTransform(scrollYProgress, [0.3, 0.5], [0, 1])
            ...
            >
              <g transform="translate(28.5, 15)">
                ...
                <motion.path
                  ...
                  // 2. EZ A KULCS: Fixálja a böngésző kerekítési hibáját a végpontnál
                  pathLength="1"
