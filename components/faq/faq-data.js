const faqData = [
  ...
  // ==========================================
  {
    title: 'Mennyibe kerül a teljes körű családi pénzügyi elemzés és tanácsadás?',
  ...
  {
    title: 'Hogyan véd meg egy prémium lakásbiztosítás az alulbiztosítottság ellen?',
    category: 'csalad-tamogatas',
    description:
  ...
  {
    title: 'Milyen előnyökkel jár az állami támogatások (CSOK+, Babaváró) bankfüggetlen intézése?',
    category: 'csalad-tamogatas',
    description:
  ...
  {
    title: 'Mikor és hogyan segít a hitelkiváltás és adósságrendezés a családi kasszának?',
    category: 'csalad-tamogatas',
    description:
  ...
  {
    title: 'Miért elengedhetetlen a gyermek baleset- és sportbiztosítás az aktív mindennapokban?',
    category: 'csalad-tamogatas',
    description:
  ...
  {
    title: 'Hogyan maximalizálható az évi 20%-os állami adójóváírás az öngondoskodással?',
    category: 'szemelyes-jovotervezes',
    description:
