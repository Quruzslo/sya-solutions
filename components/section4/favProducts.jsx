  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col xl:flex-row gap-6 my-[35px]">
        ...
        <div
          ref={tabRef}
          className="tartalom w-100% xl:w-[55%]  relative !overflow-hidden"
        >
          {products.map((prod) => {
            const isActive = activeTab === prod.id;
            ...
            if (isActive) {
              ...
              containerClass =
                "block tab-exiting z-0 absolute top-0 left-0 w-full h-full";
            }
            ...
            return (
              ...
              >
                ...
                <div className="stagger-item delay-1">
                  ...
                  <h2 className="!text-[20px] fav-prod xl:text-3xl font-bold text-text-alap mt-2">
                    {prod.title}
                  </h2>
                </div>
